...
_CONFIGS = [
    ...
    TrainConfig(
        ...
        data=LeRobotTavlaDataConfig(
            ...
            default_prompt="When a round PCB stops at the pickup position on the green conveyor belt, grasp the PCB with the gripper, lift it up, move to the yellow tray on the green table next to the conveyor, and place the PCB flat into the center of the yellow tray. If no yellow tray is detected on the table, return the arm to the initial home position instead.",
        ),
        ema_decay=None,
