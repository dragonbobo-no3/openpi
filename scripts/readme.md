...
NCCL_NVLS_ENABLE=0 XLA_PYTHON_CLIENT_MEM_PREALLOCATE=false uv run scripts/train.py pi05_agileX --exp-name=/jedata/jemotor/model --data.repo_id=0911_pi05_test --overwrite --no_wandb_enabled
