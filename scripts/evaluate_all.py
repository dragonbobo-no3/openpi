...
def run_infer_and_save(args):
    ...
    import jax
    policy._rng = jax.random.PRNGKey(123456)
...
def build_cli():
    ...
    p_run.add_argument("--checkpoint_dir", default="/jedata/jemotor/model/1017_test/60000")
    p_run.add_argument("--repo_id", default="lerobot/test")
    p_run.add_argument("--root", default="/jedata/test_0928_100_v2/")
    p_run.add_argument("--episode_id", type=int, default=85)
    p_run.add_argument("--default_prompt", default="pick up the circular chip and place it on the yellow pot")
    p_run.add_argument("--out", default="./cloud_all_save1.npz")
    ...
    p_plot.add_argument("--inp", default="./cloud_all_save1.npz")
    p_plot.add_argument("--out", default="./cloud_all_save1.png")
    p_plot.add_argument("--dpi", type=int, default=150)
    p_plot.add_argument("--pred_start", type=int, default=31, help="Start frame for using pred_actions in plot.")
