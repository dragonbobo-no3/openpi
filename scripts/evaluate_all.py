...
def build_cli():
    ...
    p_run.add_argument("--checkpoint_dir", default="/home/kleist/Documents/Model/cloud_server/1017_pi05_test/60000/")
    p_run.add_argument("--repo_id", default="lerobot/test")
    p_run.add_argument("--root", default="/home/kleist/Documents/Database/test_0928_100_v2_no_replace/")
    ...
    p_run.add_argument("--out", default="./a5880_save1_1021b1.npz")
